...
#import "iHackerProAppDelegate.h"
...
//--------------------
@interface iHackerProAppDelegate ()
-(void)removeImage:(UIImageView*)imageView;
@end
//--------------------


@implementation iHackerProAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
	...
	[self performSelector:@selector(removeImage:) withObject:loadingImage afterDelay:0.36];
...
/*- (BOOL)application:(UIApplication *)application handleOpenURL:(NSURL *)url {
	if ([[url scheme] isEqualToString:@"iHackerPro"] || [[url scheme] isEqualToString:@"ihackerpro"]) {
