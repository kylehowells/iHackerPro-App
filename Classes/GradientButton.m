...
- (void)useWhiteStyle
{
	...
	color = [UIColor colorWithRed:0.652 green:0.652 blue:0.651 alpha:1.0];
	[colors2 addObject:(id)[color CGColor]];
	color = [UIColor colorWithRed:0.764 green:0.764 blue:0.764 alpha:1.0];
	[colors2 addObject:(id)[color CGColor]];
	color = [UIColor colorWithRed:0.786 green:0.786 blue:0.786 alpha:1.0];
	[colors2 addObject:(id)[color CGColor]];
    self.highlightGradientColors = colors2;
